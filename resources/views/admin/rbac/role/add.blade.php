...
<script src="{{asset("asset/admin/js/plugins/ztree/js/jquery.ztree.excheck.js")}}"></script>
<script>
    $(function () {
        var setting = {
            data: {
            ...
            callback: {
                onCheck: function (event, treeId, treeNode) {
                    var html = '<input type="hidden" name="permission[]" value="' + treeNode.id + '">';
                    if (treeNode.checked) {
                        ...
                        $('#permission').find('input[value=' + treeNode.id + ']').remove();
                    }
                }
            }
        };
